...
- common options can be defined in [`keymaps/settings.h`](keymaps/settings.h)
- the keymap itself can be customized in [`keymaps/quacken.keymap`](keymaps/quacken.keymap)
